...
<head>
    ...
    <style>
        ...
        body:not(.dept-is-gudang) #section-extra-fields {
                            ...
                            <div class="coco-card" style="margin-bottom: 0;">
                                <form id="tracking-form" onsubmit="event.preventDefault(); sendTracking();">
                                    ...
                                    <div style="margin-bottom: 24px;">
                                        ...
                                        <!-- Container Field Nomor Kontainer & Extra Fields (Ukuran) -->
                                        <div id="no-cont-wrapper" style="display: grid; grid-template-columns: <?= $activeDept === 'gudang' ? '1.35fr 1fr' : '1fr' ?>; gap: 16px; margin-bottom: 14px;">
                                            ...
                                            <div class="field-group" id="ukuran-cont-group" style="<?= $activeDept === 'gudang' ? '' : 'display: none;' ?>">
                                        ...
                                        <!-- Extra fields (Hanya untuk Gudang, disembunyikan untuk TPP agar user tidak perlu mengisi/memilih data lain) -->
                                        <div id="section-extra-fields" style="<?= $activeDept === 'gudang' ? '' : 'display: none;' ?>">
    ...
    <script>
        ...
        function setDepartment(dept, isInit = false) {
            ...
            if (dept === 'gudang') {
                ...
                // Show extra inputs for Gudang
                $('#ukuran-cont-group').show();
                $('#section-extra-fields').show();
                $('#no-cont-wrapper').css('grid-template-columns', '1.35fr 1fr');
                ...
                $('#ukuran-cont-group').hide();
                $('#section-extra-fields').hide();
                $('#no-cont-wrapper').css('grid-template-columns', '1fr');
        ...
        async function fetchContainerTimeline(contNo) {
            ...
            summaryBar.html(`<div style="display:flex; align-items:center; gap:8px; padding:4px 0; color:var(--accent-blue);"><span class="pulse-dot"></span> Sedang menelusuri riwayat 6 alur pergerakan kontainer <b>${contNo}</b> di database ${currentDept.toUpperCase()}...</div>`);
            cardsGrid.html(`
